...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(width, height, "TITANITE ENGINE", NULL, NULL);
	...
	std::string texPath = "C:/Resources/Textures/cobstone.png";
